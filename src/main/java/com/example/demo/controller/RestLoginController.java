...
public class RestLoginController {
	...
	@PostMapping("/login")
	public ResponseEntity<ApiResponse<Void>> login(@RequestBody LoginRequest request, HttpSession session) {
	    try {
	        UserCert cert = certService.getCert(request.getUsername(), request.getPassword());
